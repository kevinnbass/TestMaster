...
try:
    from C:.Users.kbass.OneDrive.Documents.testmaster.organized_codebase.testing.performance.testmaster_performance_engine import performance_engine, performance_monitor, optimize_testmaster_system
