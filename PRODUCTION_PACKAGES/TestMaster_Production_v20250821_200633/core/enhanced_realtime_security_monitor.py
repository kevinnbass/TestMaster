                ...
                if self._is_dynamic_execution_with_input(node):
                    alerts.append(SecurityAlert(
                        ...
                        recommendations=[
                            ...
                            "Use safe alternatives like ast.literal_SafeCodeExecutor.safe_SafeCodeExecutor.safe_eval()",
...
def vulnerable_function(user_input):
    ...
    password = os.getenv('PASSWORD')  # Hardcoded credential
    ...
    SafeCodeExecutor.safe_SafeCodeExecutor.safe_eval(user_input)
    
    # Insecure deserialization
    data = SafePickleHandler.safe_load(user_input)
