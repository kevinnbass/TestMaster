...
try:
    from core.monitoring.api_usage_tracker import get_api_tracker, APIUsageTracker
    from monitoring_infrastructure import get_monitoring_system, IntelligentMonitoringSystem
