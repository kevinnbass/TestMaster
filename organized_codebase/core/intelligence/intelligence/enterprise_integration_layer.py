"""
Enterprise_Integration_Layer Module - Import Redirect
==========================================
...
Split modules location: enterprise_integration_layer_modules/
"""

# Import all components from split modules to maintain backward compatibility
from .enterprise_integration_layer_modules import *

# Preserve original module's public interface
__all__ = []
try:
    # Import any __all__ definitions from split modules
    from .enterprise_integration_layer_modules import __all__ as split_all
...
__split_timestamp__ = "2025-08-21T04:20:18.412765"
