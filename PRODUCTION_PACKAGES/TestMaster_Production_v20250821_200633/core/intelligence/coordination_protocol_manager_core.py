"""
Coordination Protocol Manager Core
==================================

Master coordination protocol orchestrator with enterprise-grade communication systems,
conflict resolution, background processing loops, and framework integration management.

Agent A - Hour 24: Intelligence System Coordination Core
Extracted from coordination_protocol_manager.py for enhanced modularity.
"""
...
# Import types and handlers from local modules
from .coordination_types import (
    CoordinationMessage, MessageType, MessagePriority, CoordinationPattern,
    ProtocolType, ProtocolConfiguration, EventSubscription, ConflictResolutionRule
)
from .message_handlers import (
    MessageHandler, CommandMessageHandler, QueryMessageHandler, 
    EventMessageHandler, ResponseMessageHandler
)
