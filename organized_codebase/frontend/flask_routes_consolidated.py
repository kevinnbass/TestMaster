#!/usr/bin/env python3
"""
STEELCLAD MODULE: Flask Routes Consolidated
===========================================

All Flask routes extracted from unified_dashboard_modular.py
Original: 1,154 lines → Routes Module: ~560 lines
...
def register_flask_routes(app, dashboard_instance):
    ...
    @app.route('/api/contextual-analysis')
