...
from database_optimization_models import QueryAnalysis, IndexRecommendation, ConnectionPoolConfig
...
from database_optimization_core import DatabasePerformanceOptimizer
